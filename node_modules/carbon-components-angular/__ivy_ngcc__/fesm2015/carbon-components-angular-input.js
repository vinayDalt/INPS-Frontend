...
function Label__svg_svg_5_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵnamespaceSVG();
...
function Label_div_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵtemplate(2, Label_div_7_2_Template, 1, 1, undefined, 10);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function Label_div_8_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementContainerStart(0);
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementContainerEnd();
} if (rf & 2) {
...
function Label_div_8_2_Template(rf, ctx) { if (rf & 1) {
...
function Label_div_8_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "div", 12);
    ɵngcc0.ɵɵtemplate(1, Label_div_8_ng_container_1_Template, 2, 1, "ng-container", 10);
    ɵngcc0.ɵɵtemplate(2, Label_div_8_2_Template, 1, 1, undefined, 10);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function Label_div_9_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementContainerStart(0);
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementContainerEnd();
} if (rf & 2) {
...
function Label_div_9_2_Template(rf, ctx) { if (rf & 1) {
...
function Label_div_9_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "div", 12);
    ɵngcc0.ɵɵtemplate(1, Label_div_9_ng_container_1_Template, 2, 1, "ng-container", 10);
    ɵngcc0.ɵɵtemplate(2, Label_div_9_2_Template, 1, 1, undefined, 10);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
const _c3 = function (a0) { return { "bx--text-input__field-wrapper--warning": a0 }; };
const _c4 = ["*", "input,textarea,div"];
class TextInput {
    constructor() {
        /**
...
TextInput.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: TextInput, selectors: [["", "ibmText", ""]], hostVars: 14, hostBindings: function TextInput_HostBindings(rf, ctx) { if (rf & 2) {
    ...
    } }, inputs: { theme: "theme", size: "size", invalid: "invalid", warn: "warn", skeleton: "skeleton" } });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TextInput, [{
        ...
        args: [{
            ...
            type: HostBinding,
            args: ["class.bx--text-input__field-wrapper--warning"]
        }, {
            type: Input
        }], skeleton: [{
            type: HostBinding,
...
Label.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Label, selectors: [["ibm-label"]], contentQueries: function Label_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, inputs: { labelState: "labelState", skeleton: "skeleton", invalid: "invalid", warn: "warn", helperText: "helperText", invalidText: "invalidText", warnText: "warnText", ariaLabel: "ariaLabel" }, ngContentSelectors: _c4, decls: 10, vars: 16, consts: [[1, "bx--label", 3, "for", "ngClass"], [3, "ngClass"], ["wrapper", ""], ["ibmIcon", "warning--filled", "size", "16", "class", "bx--text-input__invalid-icon bx--text-area__invalid-icon", 4, "ngIf"], ["ibmIcon", "warning--alt--filled", "size", "16", "class", "bx--text-input__invalid-icon bx--text-input__invalid-icon--warning", 4, "ngIf"], ["class", "bx--form__helper-text", 4, "ngIf"], ["class", "bx--form-requirement", 4, "ngIf"], ["ibmIcon", "warning--filled", "size", "16", 1, "bx--text-input__invalid-icon", "bx--text-area__invalid-icon"], ["ibmIcon", "warning--alt--filled", "size", "16", 1, "bx--text-input__invalid-icon", "bx--text-input__invalid-icon--warning"], [1, "bx--form__helper-text"], [4, "ngIf"], [3, "ngTemplateOutlet"], [1, "bx--form-requirement"]], template: function Label_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef(_c1);
        ɵngcc0.ɵɵelementStart(0, "label", 0);
        ɵngcc0.ɵɵprojection(1);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementStart(2, "div", 1, 2);
        ɵngcc0.ɵɵtemplate(4, Label__svg_svg_4_Template, 1, 0, "svg", 3);
        ɵngcc0.ɵɵtemplate(5, Label__svg_svg_5_Template, 1, 0, "svg", 4);
        ɵngcc0.ɵɵprojection(6, 1);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵtemplate(7, Label_div_7_Template, 3, 2, "div", 5);
        ɵngcc0.ɵɵtemplate(8, Label_div_8_Template, 3, 2, "div", 6);
        ɵngcc0.ɵɵtemplate(9, Label_div_9_Template, 3, 2, "div", 6);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("for", ctx.labelInputID)("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c2, ctx.skeleton));
        ɵngcc0.ɵɵattribute("aria-label", ctx.ariaLabel);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵclassMap(ctx.wrapperClass);
        ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(14, _c3, ctx.warn));
