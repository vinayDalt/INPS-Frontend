...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-damhlskh55t">Show
  modal</button>

<div data-modal id="modal-damhlskh55t" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-damhlskh55t-label" aria-describedby="modal-damhlskh55t-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-damhlskh55t-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-damhlskh55t-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-damhlskh55t" class="bx--label">Text Input label</label>
        <input id="text-input-damhlskh55t" type="text" class="bx--text-input" placeholder="Optional placeholder text"
