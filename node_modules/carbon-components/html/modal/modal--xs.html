...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-apkp8i4ubz">Show
  modal</button>

<div data-modal id="modal-apkp8i4ubz" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-apkp8i4ubz-label" aria-describedby="modal-apkp8i4ubz-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-apkp8i4ubz-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-apkp8i4ubz-heading">Modal heading</p>
