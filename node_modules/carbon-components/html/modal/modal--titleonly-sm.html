...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-wurm44vk34k">Show
  modal</button>

<div data-modal id="modal-wurm44vk34k" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-wurm44vk34k-label" aria-describedby="modal-wurm44vk34k-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-wurm44vk34k-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-wurm44vk34k-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
