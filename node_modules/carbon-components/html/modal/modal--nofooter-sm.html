...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vklfueacyf">Show
  modal</button>

<div data-modal id="modal-vklfueacyf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vklfueacyf-label" aria-describedby="modal-vklfueacyf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vklfueacyf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vklfueacyf-heading">Modal heading</p>
