...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-tqaccx3yggb">Show
  modal</button>

<div data-modal id="modal-tqaccx3yggb" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-tqaccx3yggb-label" aria-describedby="modal-tqaccx3yggb-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tqaccx3yggb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tqaccx3yggb-heading">Modal heading</p>
