...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-0rbp3x202d6k">Show
  modal</button>

<div data-modal id="modal-0rbp3x202d6k" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-0rbp3x202d6k-label" aria-describedby="modal-0rbp3x202d6k-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-0rbp3x202d6k-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-0rbp3x202d6k-heading">Modal heading</p>
