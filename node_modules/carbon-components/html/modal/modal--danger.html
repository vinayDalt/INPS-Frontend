...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-jyd4a1njin">Show
  modal</button>

<div data-modal id="modal-jyd4a1njin" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-jyd4a1njin-label" aria-describedby="modal-jyd4a1njin-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jyd4a1njin-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jyd4a1njin-heading">Modal heading</p>
