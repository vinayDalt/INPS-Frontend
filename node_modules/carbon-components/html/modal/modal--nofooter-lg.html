...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-r770157ykf">Show
  modal</button>

<div data-modal id="modal-r770157ykf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-r770157ykf-label" aria-describedby="modal-r770157ykf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-r770157ykf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-r770157ykf-heading">Modal heading</p>
