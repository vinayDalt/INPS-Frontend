...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-m8uftiggvbd">Show
  modal</button>

<div data-modal id="modal-m8uftiggvbd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-m8uftiggvbd-label" aria-describedby="modal-m8uftiggvbd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-m8uftiggvbd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-m8uftiggvbd-heading">Modal heading</p>
