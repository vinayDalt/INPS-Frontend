...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-i1li766fpvb">Show
  modal</button>

<div data-modal id="modal-i1li766fpvb" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-i1li766fpvb-label" aria-describedby="modal-i1li766fpvb-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-i1li766fpvb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-i1li766fpvb-heading">Modal heading</p>
