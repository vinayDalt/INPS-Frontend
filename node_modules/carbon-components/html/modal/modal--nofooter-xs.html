...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-p20p4s74wo">Show
  modal</button>

<div data-modal id="modal-p20p4s74wo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-p20p4s74wo-label" aria-describedby="modal-p20p4s74wo-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-p20p4s74wo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-p20p4s74wo-heading">Modal heading</p>
